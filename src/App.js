    ...
    <Router>
      <div className="App">
        ...
        <Routes>
          ...
          <Route path="/Supplier" element={<PrivateRoute isLogin={isLogin} user={user} role={role} isLogout={isLogout} handleLogout={handleLogout} purchases={purchases} addPurchase={addPurchase} gudangData={gudangData} setGudangData={setGudangData} requests={requests} acceptRequest={acceptRequest} declineRequest={declineRequest} requestMoreInfo={requestMoreInfo} onRequest={handleRequest} onDeleteRequest={handleDeleteRequest} acceptPurchase={acceptPurchase} declinePurchase={declinePurchase}/>} />
