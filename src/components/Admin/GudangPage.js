...
import AddBarang from '../Gudang/AddBarang';
import EditBarang from '../Gudang/EditBarang';
import DeleteBarang from '../Gudang/DeleteBarang'; // Impor komponen DeleteBarang
import data from "../../data/barang.json";

const GudangPage = ({ gudangData, setGudangData }) => {
